...
\section{28. The weeking has to be deep within one-self like diving to recover a precious object that has fallen in deep waters.}
...
\section{29. The vichara is not muttering ``I'' but sinking the mind into its source.}
...
\section{30. On reaching the heart, the ``I'' subsides and the real ``I'' I''I manifests in its place.}
...
\section{32. Although ``Thou art THAT'', say the Vedas, not to investigate into one's nature and ``abide as THAT'' is mental weakness.}
